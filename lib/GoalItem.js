        ...
        items2.forEach(function(item2) {
          if ((typeOf(item2) === "doubledotteditem") && (item2.data.left_dot > 0)) {
            ...
            if ((item2.data.rule.rhs[item2.data.left_dot-1] === item1.data.nonterminal) && 
              ...
              var new_item = new DoubleDottedItem(item2.data.rule, item2.data.left_dot-1, item2.data.right_dot, item1.data.from, item2.data.to);
        ...
        items2.forEach(function(item2) {
          if (typeOf(item2) === "cyk_item") {
            ...
            if ((item1.data.rule.rhs[item1.data.right_dot] === item2.data.nonterminal) &&
              ...
              var new_item = new DoubleDottedItem(item1.data.rule, item1.data.left_dot, item1.data.right_dot+1, item1.data.from, item2.data.to);
