...
TypeLattice.prototype.add_type = function(type) {
  ...
  logger.debug('TypeLattice.add_type: ' + type.prettyPrint());
  // add a row to the lubMatrix of length this.number_of_types
  this.lubMatrix.push(Array(this.number_of_types));
