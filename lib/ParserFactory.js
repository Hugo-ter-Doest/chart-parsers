...
ParserFactory.prototype.createParser = function(options) {
  ...
  if (options.unification !== undefined) {
    ...
    logger.debug('ParserFactory.createParser: change value of unification' +
      ' setting to ' + global.config.UNIFICATION);
  }
  ...
  if (options.pathToLexicalCategory) {
    global.config.pathToLexicalCategory = options.pathToLexicalCategory;
  }
