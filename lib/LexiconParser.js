module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c14 = function(l, listOfLabels) {
           var fs = new TypedFeatureStructure({
        ...
        peg$c17 = function(feature, value) {
          var result = {};
          result.feature = feature;
          result.value = value;
          return(result);
        ...
        peg$c20 = function(bracket1, id, bracket2) {
          //return("[" + id + "]");
          return(id);
        },
        peg$c21 = /^[^"]/,
        ...
        peg$c25 = function(firstElt, restOfList) {
          var list = [firstElt];
        ...
        peg$c27 = function(l1, moreLabels) {
          var list = [l1];
    ...
    function peg$parsefeature_plus_reference() {
      ...
      if (s1 !== peg$FAILED) {
        ...
        if (s2 !== peg$FAILED) {
          ...
          if (s4 !== peg$FAILED) {
            s5 = peg$parselistOfFeatureStructures();
            if (s5 !== peg$FAILED) {
              peg$reportedPos = s3;
              s4 = peg$c14(s4, s5);
              s3 = s4;
          ...
          if (s3 === peg$FAILED) {
            s3 = peg$currPos;
            s4 = peg$parseemptyListOfFeatureStructures();
            if (s4 !== peg$FAILED) {
              peg$reportedPos = s3;
              s4 = peg$c15(s4);
            }
