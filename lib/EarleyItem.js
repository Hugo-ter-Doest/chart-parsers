...
// Determines whether unification should be applied
    ...
    items.forEach(function(item2) {
      if (item2.is_incomplete() && 
        ...
        if (UNIFICATION) {
          ...
          item2.features[item2.data.rule.rhs[item2.data.dot]] = item2.features[item2.data.rule.rhs[item2.data.dot]].
            unify(that.data.fs.features[that.data.rule.lhs]);
          if (item2.fs.features[item2.data.rule.rhs[item2.data.dot]] !== grammar.type_lattice.top) {
