...
logger.setLevel(settings.loggingLevels.LeftCornerParser);
...
util.inherits(LeftCornerChartParser, ChartParser);

LeftCornerChartParser.prototype.parse = function(tagged_sentence, func) {
  var that = this;
