...
// A list of feature structures and/or references to feature structures
listOfFeatureStructures
  = startList list: (
    (fs: feature_structure
      {map_label_to_node[genLabel()] = fs; }
     / label) *)
    endList
{
  if (!list) {
...
feature_plus_reference
  ...
  l: label ? listOfLabels: listCrossRefs
{
...
label_with_value
  = bracket1: OpenLabel id: identifier bracket2:
