...
HeadCornerChartParser.prototype.initialise = function(tagged_sentence, func) {
  var that = this;
  var new_item;
...
HeadCornerChartParser.prototype.parse = function (tagged_sentence, func) {
