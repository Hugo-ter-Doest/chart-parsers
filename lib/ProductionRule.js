...
ProductionRule.prototype.processConstraintList = function(c, signature) {
  this.type = signature.typeLattice.list;
  this.listOfCrossRefs = [];
  var that = this;
  c.right.forEach(function(path) {
    if (typeof(path) === "string") {
      that.listOfCrossRefs.push(signature.typeLattice.getTypeByName(path));
    }
