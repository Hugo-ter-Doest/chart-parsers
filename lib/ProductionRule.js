...
function ProductionRule(lhs, rhs, head) {
  ...
  this.fs = null;
  // mapping from grammar symbol to feature structure
  this.map_fs = {};
}
...
ProductionRule.prototype.process_constraint = function(constraint, type_lattice) {
  ...
  // map grammar symbol to the right feature structure
  this.map_fs[constraint.left[0]] = this.fs.features[constraint.left[0]];
  ...
  // map grammar symbol to the right feature structure
  this.map_fs[constraint.right[0]] = this.fs.features[constraint.right[0]];
