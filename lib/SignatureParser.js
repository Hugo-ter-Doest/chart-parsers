module.exports = (function() {
  ...
  function parse(input) {
    var options = arguments.length > 1 ? arguments[1] : {},
        ...
        peg$c11 = function(fs) {map_label_to_node[genLabel()] = fs; },
        peg$c12 = function(list) {
          if (!list) {
            list = [];
          }
          return(list);
        },
        peg$c13 = function(l, listOfLabels) {
        ...
        peg$c17 = function(l1, moreLabels) {
          var list = [l1];
        ...
        peg$c20 = /^[a-zA-Z_\-0-9]/,
        peg$c21 = { type: "class", value: "[a-zA-Z_\\-0-9]", description: "[a-zA-Z_\\-0-9]" },
        ...
        peg$c39 = "Type",
        peg$c40 = { type: "literal", value: "Type", description: "\"Type\"" },
        peg$c41 = "->",
    ...
    function peg$parsefeature_plus_value() {
      ...
      if (s0 === peg$FAILED) {
        s0 = peg$parselistOfFeatureStructures();
      }
