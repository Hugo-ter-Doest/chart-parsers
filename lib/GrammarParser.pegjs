...
//  / path: feature_path Equal startList atom: atom endList
//  {
//   var constraint = new Constraint(path, atom, true);
//   return(constraint);
//  }
  / path1: feature_path Equal startList path2: (feature_path / atom) listOfPaths: (listSeparator (feature_path / atom))* endList
  {
   var list = [path2];
