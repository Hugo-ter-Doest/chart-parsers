...
TypedFeatureStructure.prototype.unifiable = function(fs, signature) {
  ...
  function unifiable0(a, b, signature) {
    ...
    if (fs1.aux_type === signature.typeLattice.string) {
      ...
      return(fs1.lexicalString === fs2.lexicalString);
    }
    else {
      if (fs1.aux_type === signature.typeLattice.list) {
        ...
        if (fs1.listOfCrossRefs && fs2.listOfCrossRefs) {
          ...
          if (equal) {
            ...
            fs1.aux_listOfCrossRefs = fs1.listOfCrossRefs.slice();
          }
        }
        else {
          if (fs1.listOfCrossRefs && !fs2.listOfCrossRefs) {
            ...
            if (fs2.listOfCrossRefs && !fs1.listOfCrossRefs) {
              fs1.aux_listOfCrossRefs = fs2.listOfCrossRefs.slice();
            }
            else {
    ...
    if (fs.unifact.type === signature.typeLattice.string) {
      ...
      if (fs.unifact.type === signature.typeLattice.list) {
        if (fs.aux_listOfCrossRefs) {
          fs.unifact.listOfCrossRefs = [];
          fs.aux_listOfCrossRefs.forEach(function(ref, index) {
            fs.unifact.listOfCrossRefs[index] = copyUnifact0(ref, signature, newStack);
          });
        }
      }
    }
